class UpdateTransportationRoutes < ActiveRecord::Migration
  ...
  def down
    if index_exists? :transportation_route_stops, 'trans_route_stop_trans_route_idx'
      remove_index :transportation_route_id, name: 'trans_route_stop_trans_route_idx'
    end

    if index_exists? :transportation_route_segments, 'trans_route_seg_trans_route_id_idx'
    ...
    if column_exists? :transportation_route_segments, :miles_traveled
      rename_column :transportation_route_segments, :end_mileage, :end_mileage
      change_column :transportation_route_segments, :end_mileage, :integer
