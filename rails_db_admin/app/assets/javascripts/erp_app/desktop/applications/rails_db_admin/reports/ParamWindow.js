        ...
        return [
            {
                ...
                listeners: {
                    select: function (combo, records, eOpts) {
                        ...
                        container.down('#businessModule').store.load({params: {application_id: records[0].get('id')}})
                    },
                    change: function (combo, newValue, oldValue, eOpts) {
                        container.down('#businessModule').enable();
                        container.down('#businessModule').store.load({params: {application_id: newValue}})
                    }
                }
            },
            {
