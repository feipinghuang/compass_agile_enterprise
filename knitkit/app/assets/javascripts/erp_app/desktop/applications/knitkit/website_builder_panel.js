			...
			me.refershIntervals[iframeNode.id] = setInterval(function() {
				if (!iframeNode || !iframeNode.contentDocument || !iframeNode.contentDocument.body) {
					...
					if (!me.rowHeights[iframeNode.id]) {
						me.rowHeights[iframeNode.id] = iframeNode.contentDocument.body.scrollHeight;
						dropPanel.setHeight(iframeNode.contentDocument.body.scrollHeight);
						me.updateLayout();
					} else if (me.rowHeights[iframeNode.id] !== iframeNode.contentDocument.body.scrollHeight) {
						me.rowHeights[iframeNode.id] = iframeNode.contentDocument.body.scrollHeight;
						dropPanel.setHeight(iframeNode.contentDocument.body.scrollHeight);
						me.updateLayout();
					}
