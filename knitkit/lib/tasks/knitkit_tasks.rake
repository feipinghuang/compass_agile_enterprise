    ...
    task :insert_components => :environment do |t, args|
      COMPONENTS = [ { id: 'header1',
                     ...
                     {  id: 'content_section2',
                        title: 'Content Section',
                        type: 'content_section',
                        thumbnail: '/images/content_blocks/content_section2.png',
                        height: 550 },
                     {  id: 'content_section3',
                        title: 'Content Section',
                        type: 'content_section',
                        thumbnail: '/images/content_blocks/content_section3.png',
                        height: 550 },
                     {  id: 'content_section4',
                        title: 'Content Section',
                        type: 'content_section',
                        thumbnail: '/images/content_blocks/content_section4.png',
                        height: 550 },
                     {  id: 'content_section5',
                        title: 'Content Section',
                        type: 'content_section',
                        thumbnail: '/images/content_blocks/content_section5.png',
                        height: 550 },
                     { id: 'footer2',
                       title: 'Footer',
                       type: 'footer',
