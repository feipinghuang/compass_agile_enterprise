...
Ext.define("CompassAE.ErpApp.Shared.Party.AppsInstalledPanel", {
	...
	setDbaOrganizationOnApplications: function() {
		...
		if (me.up('businessmoduledetailview') && me.up('businessmoduledetailview').parentDetailView && me.up('businessmoduledetailview').parentDetailView.recordData.sub_module_record_type == 'Organization') {
