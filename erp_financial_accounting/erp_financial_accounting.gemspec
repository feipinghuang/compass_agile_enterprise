...
Gem::Specification.new do |s|
  ...
  s.add_dependency "erp_txns_and_accts", "~> 4.2"
  s.add_dependency "erp_agreements", "~> 4.2"
  s.add_dependency "erp_products", "~> 4.2"
  s.add_dependency "erp_orders", "~> 4.2"
  s.add_dependency "erp_commerce", "~> 4.2"
